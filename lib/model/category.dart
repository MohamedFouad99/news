class Category {
  ...
  static List<Category> getCategories() {
    return [
      ...
      Category(
          'business', 'Business', 'assets/images/business.png', 0xFFCF7E48),
      Category('entertainment', 'Entertainment',
          'assets/images/entertainment.png', 0xFF4882CF),
      Category('health', 'Health', 'assets/images/health.png', 0xFFED1E79),
      Category('science', 'Science', 'assets/images/science.png', 0xFFF2D352),
      Category('technology', 'Technology', 'assets/images/technology.png',
          0xFF003E90),
